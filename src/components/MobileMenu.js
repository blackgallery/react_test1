                ...
                <div className="header_cart">
                    <ul>
                        <li className="header_search">
                            <Link to="#" className="cart-toggler search_icon"><i className="icon-glyph-16"></i></Link>
                        ...
                        <li className="header_cart_icon">
                            <Link to="#"><i className="icon-glyph-13"></i><span className="number_cart">0</span></Link>
                        </li>
                    </ul>
                </div>
                 {/* End: Cart  */}
